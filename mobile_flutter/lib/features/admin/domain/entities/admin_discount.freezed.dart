...
class _$AdminDiscountImpl implements _AdminDiscount {
  ...
  @override
  String toString() {
    return 'AdminDiscount(discountId: $discountId, name: $name, discountType: $discountType, discountValue: $discountValue, startDate: $startDate, endDate: $endDate, status: $status, createdAt: $createdAt, productIds: $productIds, categoryIds: $categoryIds)';
  }
...
abstract class _AdminDiscount implements AdminDiscount {
  const factory _AdminDiscount(
      ...
      final List<int> categoryIds}) = _$AdminDiscountImpl;
