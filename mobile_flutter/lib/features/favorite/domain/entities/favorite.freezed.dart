...
class _$FavoriteImpl implements _Favorite {
  ...
  @override
  String toString() {
    return 'Favorite(favoriteId: $favoriteId, productId: $productId, productName: $productName, imageUrl: $imageUrl, price: $price, calendarType: $calendarType, productStatus: $productStatus, createdAt: $createdAt)';
  }
